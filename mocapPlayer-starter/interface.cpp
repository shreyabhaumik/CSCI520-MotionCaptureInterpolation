...
Fl_Button * flyCamera_button = (Fl_Button *)0;  // to show ground pattern - concentric squares
...
Fl_Window * make_window() 
{
  ...
  { 
    ...
    { 
      Fl_Button * o = flyCamera_button = new Fl_Button(650, 345, 85, 25, "Fly Cam");  // to show ground pattern - concentric squares
      o->callback((Fl_Callback*)flyCamera_callback, (void*)(0));
      o->align(FL_ALIGN_INSIDE);
    }

    { 
      Fl_Light_Button * o = fog_button = new Fl_Light_Button(650, 375, 85, 25, "Fog");
      o->callback((Fl_Callback*)useFog_callback, (void*)(0));
      o->align(FL_ALIGN_INSIDE);
    }

    { 
      Fl_Light_Button * o = worldAxes_button = new Fl_Light_Button(650, 405, 85, 25, "Axes");
      o->callback((Fl_Callback*)renderWorldAxes_callback, (void*)(0));
      o->align(FL_ALIGN_INSIDE);
    }

    { 
      Fl_Button * o = aboutPlayer_button = new Fl_Button(650, 450, 85, 25, "About");
