...
{
  EULER = 0, SLERPQUATERNION = 1, SLERPLERPQUATERNION = 2
};

extern float LEtimeElapsed, LQtimeElapsed, BEtimeElapsed, BQtimeElapsed;
...
protected:
  ...
  Quaternion<double> SlerpLerp(double t, Quaternion<double> & qStart, Quaternion<double> & qEnd);
  ...
  void LinearInterpolationSlerpQuaternion(Motion * pInputMotion, Motion * pOutputMotion, int N);
  void BezierInterpolationSlerpQuaternion(Motion * pInputMotion, Motion * pOutputMotion, int N);
  void LinearInterpolationSlerpLerpQuaternion(Motion * pInputMotion, Motion * pOutputMotion, int N);
  void BezierInterpolationSlerpLerpQuaternion(Motion * pInputMotion, Motion * pOutputMotion, int N);
  ...
  Quaternion<double> DeCasteljauSlerpQuaternion(double t, Quaternion<double> p0, Quaternion<double> p1, Quaternion<double> p2, Quaternion<double> p3); // evaluate Bezier spline at t, using DeCasteljau construction, Quaternion version
  Quaternion<double> DeCasteljauSlerpLerpQuaternion(double t, Quaternion<double> p0, Quaternion<double> p1, Quaternion<double> p2, Quaternion<double> p3);
};
