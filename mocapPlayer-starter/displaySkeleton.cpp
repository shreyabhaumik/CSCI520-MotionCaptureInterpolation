...
float DisplaySkeleton::jointColors[NUMBER_COLORS][3] =
{
  {0.0f, 1.0f, 0.0f},  // GREEN
  {1.0f, 0.0f, 0.0f},  // RED
  {0.0f, 0.0f, 1.0f}   // BLUE
};
// added bone color too
float DisplaySkeleton::boneColors[NUMBER_COLORS][3] =
{
  {0.9f, 0.8f, 0.0f},  // GREEN
  {1.0f, 0.8f, 0.7f},  // RED
  {0.6f, 0.95f, 1.0f}   // BLUE
};
...
void DisplaySkeleton::SetDisplayList(int skeletonID, Bone *bone, GLuint *pBoneList)
{
  ...
  *pBoneList = glGenLists(numbones);
  ...
  float ambientFskeleton = 0.2f; // 0.1f
  float diffuseFskeleton = 0.9f;  // 0.9f
  float specularFskeleton = 0.1f; // 0.1f

  int colorIndex = numSkeletons % NUMBER_COLORS;
  ...
  // float boneColor[3] = {1.0f, 0.9f, 0.7f};
  float boneShininess = 100.0f; 
